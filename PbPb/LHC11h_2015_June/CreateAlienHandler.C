AliAnalysisGrid* CreateAlienHandler(bool MCcase)
{
 ...
 //   plugin->SetAliROOTVersion("vAN-20141030");
    ...
    if(!MCcase) plugin->SetGridWorkingDir("11h_2015June_OnlyNclusterCut-1");
    ...
    plugin->SetSplitMaxInputFileNumber(50); //50 // 2015Feb
...
Int_t AddGoodRuns(AliAnalysisAlien* plugin,TString lhcPeriod,bool MCcase=kFALSE) {
    ...
    Int_t nruns=0,ngoodruns=0;
     ...
     nruns=20; //57
         Int_t runlist[20]={170593, 170572, 170388, 170387, 170315, 170313, 170312, 170311, 170309, 170308, 170306, 170270, 170269, 170268, 170230, 170228, 170207, 170204, 170203, 170193};
