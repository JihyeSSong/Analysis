...
fEventNumberMC(obj.fEventNumberMC),
...
//fTreeVariableMCTracks(obj.//fTreeVariableMCTracks),
...
void AliXiStar::XiStarInit()
{
    ...
    fTempStruct = new AliXiStarTrackStruct[kNbinsM*100];
...
/*
    ...
    fTreeEvent->Branch("fTreeVariableMCTracks",&fTreeVariableMCTracks,"fTreeVariableMCTracks/I");
    ...
    */
    ...
    TH2F *fDCADist = new TH2F("fDCADist","DCA distribution",kNbinsM,-.5,kNbinsM*100-.5, 100,0,10);
    fOutputList->Add(fDCADist);
    
    
    TH3F *fMultDist3d = new TH3F("fMultDist3d","Multiplicity Distribution",kNbinsM,-.5,kNbinsM*100-.5, kNbinsM,-.5,kNbinsM*100-.5, kNbinsM,-.5,kNbinsM*100-.5);
    ...
    TH1F *fMultDist2 = new TH1F("fMultDist2","Multiplicity Distribution",kNbinsM,-.5,kNbinsM*100-.5);
    fMultDist2->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist2);
    
    TH1F *fMultDist3 = new TH1F("fMultDist3","Multiplicity Distribution",kNbinsM,-.5,kNbinsM*100-.5);
    fMultDist3->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist3);
    
    TH1F *fMultDist4 = new TH1F("fMultDist4","Multiplicity Distribution",kNbinsM,-.5,kNbinsM*100-.5);
    fMultDist4->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist4);
    
    TH1F *fMultDist5 = new TH1F("fMultDist5","Multiplicity Distribution",kNbinsM,-.5,kNbinsM*100-.5);
    ...
    hEventSelecInfo->GetXaxis()->SetBinLabel(1,"kMB");
    hEventSelecInfo->GetXaxis()->SetBinLabel(2,"kCentral");
    hEventSelecInfo->GetXaxis()->SetBinLabel(3,"kSemiCentral");
    hEventSelecInfo->GetXaxis()->SetBinLabel(7,"kAny");
    hEventSelecInfo->GetXaxis()->SetBinLabel(8,"kAndMB");
    ...
    TH2F *TOFPID = new TH2F("TOFPID","PID via TOF",1000,0,5,1200,0,1.2);
    fOutputList->Add(TOFPID);
    

    TH2F *hTOFPIDpi = new TH2F("hTOFPIDpi","PID pion",1000,0,5,1200,0,1.2);
    fOutputList->Add(hTOFPIDpi);
    TH2F *hTOFPIDk = new TH2F("hTOFPIDk","PID kaon",1000,0,5,1200,0,1.2);
    fOutputList->Add(hTOFPIDk);
    TH2F *hTOFPIDp = new TH2F("hTOFPIDp","PID proton",1000,0,5,1200,0,1.2);
    fOutputList->Add(hTOFPIDp);

    
    TH2F *hQATOFNsigElec = new TH2F("hQATOFNsigElec","PID :: TOF Electron",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigElec);
    TH2F *hQATOFNsigMuon = new TH2F("hQATOFNsigMuon","PID :: TOF Muon",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigMuon);
    TH2F *hQATOFNsigPion3 = new TH2F("hQATOFNsigPion3","PID :: TOF Pion",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigPion3);
    TH2F *hQATOFNsigKaon = new TH2F("hQATOFNsigKaon","PID :: TOF Kaon",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigKaon);
    TH2F *hQATOFNsigP = new TH2F("hQATOFNsigP","PID :: TOF Proton",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigP);
    /*TH2F *hQATOFNsigPhoton = new TH2F("hQATOFNsigPhoton","PID :: TOF Photon",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigPhoton);
    TH2F *hQATOFNsigPi0 = new TH2F("hQATOFNsigPi0","PID :: TOF Pi0",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigPi0);
    TH2F *hQATOFNsigNeutron = new TH2F("hQATOFNsigNeutron","PID :: TOF Neutron",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigNeutron);
    TH2F *hQATOFNsigKaon0 = new TH2F("hQATOFNsigKaon0","PID :: TOF Kaon0",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigKaon0);
    TH2F *hQATOFNsigElecCon = new TH2F("hQATOFNsigElecCon","PID :: TOF Electron Con",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigElecCon);*/
    
    TH2F *hQATOFNsigDeutron = new TH2F("hQATOFNsigDeutron","PID :: TOF Deutron",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigDeutron);
    TH2F *hQATOFNsigTriton = new TH2F("hQATOFNsigTriton","PID :: TOF Triton",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigTriton);
    TH2F *hQATOFNsigHe3 = new TH2F("hQATOFNsigHe3","PID :: TOF He3",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigHe3);
    TH2F *hQATOFNsigAlpha = new TH2F("hQATOFNsigAlpha","PID :: TOF Alpha",1000,0,5,1200,0,1.2);
    fOutputList->Add(hQATOFNsigAlpha);
   // TH2F *hQATOFNsigUnKnown = new TH2F("hQATOFNsigUnKnown","PID :: TOF UnKnown",1000,0,5,1200,0,1.2);
   // fOutputList->Add(hQATOFNsigUnKnown);
    ...
    TH2F *hBetaProton = new TH2F("hBetaProton","Xi PID p",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaProton);
    TH2F *hBetaPion1 = new TH2F("hBetaPion1","Xi PID pi",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaPion1);
    TH2F *hBetaPion2 = new TH2F("hBetaPion2","Xi PID pi_b",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaPion2);
    
    TH2F *hBetaProtonAfter = new TH2F("hBetaProtonAfter","Xi PID p",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaProtonAfter);
    TH2F *hBetaPion1After = new TH2F("hBetaPion1After","Xi PID pi",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaPion1After);
    TH2F *hBetaPion2After = new TH2F("hBetaPion2After","Xi PID pi_b",1000,0,20,1000,-10,10);
    fOutputList->Add(hBetaPion2After);
...
*/
 ...
 //   if(fAODcase) {if (!fAOD) {Printf("ERROR: fAOD not available"); return;}}
  //  else {
    ...
    //fT0Fired = (Double_t) trAn.IsL0InputFired(esdEvent, 4); // TRUE means T0 is fired; T0 input number was 14 in 2011; it is 4 in 2012
  ...
  //  if (!isSelected) {cout<<"No event selected"<<endl; return;}
        ...
        Bool_t isSelectedC =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() & AliVEvent::kCentral);
             if(isSelectedC) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(2);
        
        Bool_t isSelectedSC =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() & AliVEvent::kSemiCentral);
           if(isSelectedSC) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(3);
        ...
        if(!isSelectedC) {cout<<"Event Rejected"<<endl; return;}
    //    if(centralityV0M>5.0) return;
        
    

    ((TH1F*)fOutputList->FindObject("hCentralitykSelected"))->Fill(centralityV0M);
    ...
    // ESDs
       ...
       //if(fMCcase) fTreeVariableEventNumber1 = GetMCEventNumber();
        ...
        if(fMCcase){
         ...
         //fTreeVariableMCTracks = myMCTracks;
       // cout<<"There are "<<  myMCTracks <<"  myMCTracks : input "<<endl;
        ...
        for (Int_t i = 0; i < fESD->GetNumberOfTracks(); i++) {
            ...
            Float_t fTOFlength = esdtrack->GetIntegratedLength();
            fTOFlength = fTOFlength*0.01;
            Float_t timeTOF = esdtrack->GetTOFsignal();
            Float_t fTOFTime = timeTOF*1E-3;
            fTOFTime = fTOFTime*c;
            
            //Float_t time0 = fPIDResponse->GetTOFResponse().GetStartTime(esdtrack->P());
            //Float_t fTOFTime =  esdtrack->GetTOFsignal()-time0;
            Float_t fTOFPIDmom = esdtrack->P();
            //Float_t fBeta = fTOFlength/(2.99792457999999984e-02 * fTOFTime);
            
            if(fTOFTime<=0 || fTOFTime>29. ) continue;
            if(fTOFlength<=0) continue;
            
         //   cout << "TOF length" << fTOFlength << endl;
         //   cout << "TOF time" << fTOFTime << endl;

            
            if((fTOFPIDmom*fTOFPIDmom)==0) continue;
            Float_t fBeta = fTOFlength/fTOFTime;

        /*
            //Double_t intTime[15] = {-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.,-99.}; //            Double_t intTime[1] = {-99.};
            //Float_t timeTOF = esdtrack->GetTOFsignal();
            Double_t intTime[AliPID::kSPECIESC];
            esdtrack->GetIntegratedTimes(intTime,AliPID::kSPECIESC);
            //esdtrack->GetIntegratedTimes(intTime);
            Float_t timeElec = intTime[2]; //            Float_t timeElec = intTime[0];
            Float_t intLength = 2.99792458e-2* timeElec;
            Double_t beta; // =0.1;
            if((intLength < 0) || (timeTOF < 0)) continue;
            beta = intLength/2.99792458e-2/timeTOF;
            
         */
            
            
            Float_t fTOFNsigElec= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kElectron));
            Float_t fTOFNsigMuon= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kMuon));
            Float_t fTOFNsigPion3= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kPion));
            Float_t fTOFNsigKaon= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kKaon));
            Float_t fTOFNsigP= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kProton));
            //Float_t fTOFNsigPhoton= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kPhoton));
            //Float_t fTOFNsigPi0= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kPi0));
            //Float_t fTOFNsigNeutron= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kNeutron));
            //Float_t fTOFNsigKaon0= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kKaon0));
            //Float_t fTOFNsigElecCon= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kEleCon));
            Float_t fTOFNsigDeutron= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kDeuteron));
            Float_t fTOFNsigTriton= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kTriton));
            Float_t fTOFNsigHe3= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kHe3));
            Float_t fTOFNsigAlpha= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kAlpha));
            //Float_t fTOFNsigUnKnown= fabs(fPIDResponse->NumberOfSigmasTOF(esdtrack,AliPID::kUnknown));

            ((TH2F*)fOutputList->FindObject("TOFPID"))->Fill(fTOFPIDmom,fBeta);
            
            if(fTOFNsigElec<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigElec"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigMuon<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigMuon"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigPion3<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigPion3"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigKaon<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigKaon"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigP<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigP"))->Fill(fTOFPIDmom,fBeta);
            //if(fTOFNsigPhoton<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigPhoton"))->Fill(fTOFPIDmom,fBeta);
            //if(fTOFNsigPi0<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigPi0"))->Fill(fTOFPIDmom,fBeta);
            //if(fTOFNsigNeutron<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigNeutron"))->Fill(fTOFPIDmom,fBeta);
            //if(fTOFNsigKaon0<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigKaon0"))->Fill(fTOFPIDmom,fBeta);
            //if(fTOFNsigElecCon<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigElecCon"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigDeutron<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigDeutron"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigTriton<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigTriton"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigHe3<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigHe3"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigAlpha<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigAlpha"))->Fill(fTOFPIDmom,fBeta);
           // if(fTOFNsigUnKnown<10.)((TH2F*)fOutputList->FindObject("hQATOFNsigUnKnown"))->Fill(fTOFPIDmom,fBeta);
                                                                   
            
            if(fTOFNsigPion3<3.) ((TH2F*)fOutputList->FindObject("hTOFPIDpi"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigKaon<3.) ((TH2F*)fOutputList->FindObject("hTOFPIDk"))->Fill(fTOFPIDmom,fBeta);
            if(fTOFNsigP<3.) ((TH2F*)fOutputList->FindObject("hTOFPIDp"))->Fill(fTOFPIDmom,fBeta);
           
            
            
            //=========selecting 3rd pionusing PID=========//
            if(nsigpi>3.) continue; // last update // 20140715 // TPC
            if(fTOFNsigPion3>3.) continue; // 20150211 // TOF
    ...
    for(Int_t i=0; i<fESD->GetNumberOfCascades(); i++){
        ...
        Double_t fTOFNSigProton = 10;
        Double_t fTOFNSigPion1 = 10;
        Double_t fTOFNSigPion2 = 10;
        
        
        Double_t fTPCPIDMomXi[3] = {-10,-10,-10};
        Double_t fNSigTPCXi[3] = {-10,-10,-10};
        
        Double_t fTOFPIDMomXi[3] = {-10,-10,-10};
      //  Double_t fNSigTOFXi[3] = {-10,-10,-10};
        ...
        if(Xicandidate->Charge() == -1){
            ...
            fTOFNSigProton = fPIDResponse->NumberOfSigmasTOF(pTrackXi,AliPID::kProton);
            fTOFNSigPion1 = fPIDResponse->NumberOfSigmasTOF(nTrackXi,AliPID::kPion);
            fTOFNSigPion2 = fPIDResponse->NumberOfSigmasTOF(bTrackXi,AliPID::kPion);
            ...
            fTOFPIDMomXi[0] = pTrackXi->P();
           // fNSigTOFXi[0] = pTrackXi->GetTOFsignal();
            
            fTOFPIDMomXi[1] = nTrackXi->P();
          //  fNSigTOFXi[1] = nTrackXi->GetTOFsignal();
            
            fTOFPIDMomXi[2] = bTrackXi->P();
           // fNSigTOFXi[2] = bTrackXi->GetTOFsignal();
            ...
            fTOFNSigProton = fPIDResponse->NumberOfSigmasTOF(nTrackXi,AliPID::kProton);
            fTOFNSigPion1 = fPIDResponse->NumberOfSigmasTOF(pTrackXi,AliPID::kPion);
            fTOFNSigPion2 = fPIDResponse->NumberOfSigmasTOF(bTrackXi,AliPID::kPion);
            ...
            fTOFPIDMomXi[0] = nTrackXi->P();
         //   fNSigTOFXi[0] = nTrackXi->GetTOFsignal();
            
            fTOFPIDMomXi[1] = pTrackXi->P();
         //   fNSigTOFXi[1] = pTrackXi->GetTOFsignal();
        ...
        ((TH2F*)fOutputList->FindObject("hBetaProton"))->Fill(fTOFPIDMomXi[0],fTOFNSigProton);
        ((TH2F*)fOutputList->FindObject("hBetaPion1"))->Fill(fTOFPIDMomXi[1],fTOFNSigPion1);
        ((TH2F*)fOutputList->FindObject("hBetaPion2"))->Fill(fTOFPIDMomXi[2],fTOFNSigPion2);
        ...
        if(fTOFNSigProton>-3.&&fTOFNSigProton<3.)((TH2F*)fOutputList->FindObject("hBetaProtonAfter"))->Fill(fTOFPIDMomXi[0],fTOFNSigProton);
        if(fTOFNSigPion1>-3.&& fTOFNSigPion1<3.) ((TH2F*)fOutputList->FindObject("hBetaPion1After"))->Fill(fTOFPIDMomXi[1],fTOFNSigPion1);
        if(fTOFNSigPion2>-3.&&fTOFNSigPion2<3.)((TH2F*)fOutputList->FindObject("hBetaPion2After"))->Fill(fTOFPIDMomXi[2],fTOFNSigPion2);
        

        
        if(fTPCNSigProton<-3.||fTPCNSigProton>3.) continue; // PID for proton
        if(fTPCNSigPion1<-3.||fTPCNSigPion1>3.) continue; // PID for 1st pion
        if(fTPCNSigPion2<-3.||fTPCNSigPion2>3.) continue; // PID for 2nd pion
        
        
       // if(fTOFNSigProton<-3.||fTOFNSigProton>3.) continue; // PID for proton
       // if(fTOFNSigPion1<-3.||fTOFNSigPion1>3.) continue; // PID for 1st pion
       // if(fTOFNSigPion2<-3.||fTOFNSigPion2>3.) continue; // PID for 2nd pion
        ...
        // if(sqrt( pow(tempX[0],2) + pow(tempX[1],2) ) > fMaxDecayLength) continue; // for myxitracks, this is moved to after the myxitracks
...
*/
     ...
     // cout<<"There are "<<myxiTracks<<"  myxiTracks"<<endl;
