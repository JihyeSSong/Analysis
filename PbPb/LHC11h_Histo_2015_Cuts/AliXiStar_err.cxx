...
/*
    ...
    */
    ...
    TH2F *fDCADist = new TH2F("fDCADist","DCA distribution",kNbinsM*10,-.5,kNbinsM*100-.5, 100,0,10);
    fOutputList->Add(fDCADist);
    
    
    TH3F *fMultDist3d = new TH3F("fMultDist3d","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5, kNbinsM*10,-.5,kNbinsM*100-.5, kNbinsM*10,-.5,kNbinsM*100-.5);
    ...
    TH1F *fMultDist1 = new TH1F("fMultDist1","Multiplicity Distribution",kNbinsM*10,0,kNbinsM*100);
    fMultDist1->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist1);
    
    TH1F *fMultDist2 = new TH1F("fMultDist2","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5);
    fMultDist2->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist2);
    
    TH1F *fMultDist3 = new TH1F("fMultDist3","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5);
    fMultDist3->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist3);
    
    TH1F *fMultDist4 = new TH1F("fMultDist4","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5);
    fMultDist4->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist4);
    
    TH1F *fMultDist5 = new TH1F("fMultDist5","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5);
    ...
    TH1F *hXiDist = new TH1F("hXiDist","Xi invariant mass distribution : cent 0 - 10",200,1.2,1.4);
    fOutputList->Add(hXiDist);
...
void AliXiStar::Exec(Option_t *)
{
   ...
   ((TH2F*)fOutputList->FindObject("hV0AC"))->Fill(fV0ATime-fV0CTime,fV0ATime+fV0CTime);
    ...
    // Event selection by physics selection class //
    ...
    if(fMCcase){
       ...
       // cout<<"There are "<<  myMCTracks <<"  myMCTracks : input "<<endl;
        ...
        for (Int_t i = 0; i < fESD->GetNumberOfTracks(); i++) {
            ...
            if(nsigpi<3.) ((TH2F*)fOutputList->FindObject("hTPCPIDpi"))->Fill(pidmom,sigTPC);
            if(nsigk<3.) ((TH2F*)fOutputList->FindObject("hTPCPIDk"))->Fill(pidmom,sigTPC);
            if(nsigpr<3.) ((TH2F*)fOutputList->FindObject("hTPCPIDp"))->Fill(pidmom,sigTPC);
...
*/
        ...
        if(StandardXi){
            if(xiCharge == -1) {
                ...
                ((TH1F*)fOutputList->FindObject("hXiDist"))->Fill(xiMass);
            }
            else {
