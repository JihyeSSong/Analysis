AliAnalysisGrid* CreateAlienHandler(bool MCcase)
{
    ...
    // gSystem->Setenv("alien_CLOSE_SE","ALICE::Bari::SE");
    ...
    if(!MCcase) plugin->SetGridWorkingDir("LHC11h_NewCentrality_JUNE17_Set4To6_Signal-TPC25");
  ...
  //  else plugin->SetGridWorkingDir("LHC11h_MC_kCentral_LHC14a1a_June6");
   // else plugin->SetGridWorkingDir("LHC11h_MC_kSemiCentral_LHC14a1b_June6");
    //else plugin->SetGridWorkingDir("LHC11h_MC_kMB_LHC14a1c_June6");
     ...
     else plugin->SetGridWorkingDir("LHC11h_MC_kMB_LHC14a1c_June6-add5");

    // Declare alien output directory. Relative to working directory.
    plugin->SetGridOutputDir("output"); // In this case will be $HOME/work/output
    plugin->SetMaxMergeFiles(20); // ********* TURN ON for data
    ...
    if(!MCcase)plugin->SetSplitMaxInputFileNumber(20);// // TURN ON for data
