...
void AliXiStarPbPb::XiStarInit()
{
 ...
 //inpPb   fMultBins = 11;// This must also be set in AliXiStarPbPb.h
  ...
  //  fMultBins = 4;// for semi - central collisions
    ...
    else fEventsToMix = 3; // original 40 jisong
...
void AliXiStarPbPb::Exec(Option_t *)
{
  ...
  //  fMCcase = kTRUE;
    ...
    Bool_t isSelectedMBall = kFALSE;
    if(centralityV0M>51. && centralityV0M<90.){
    isSelectedMBall= !(isSelectedkCentral|isSelectedkSemiCentral) && isSelected;
    if(isSelectedMBall) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(4);
    }
    ...
    if(!fMCcase){
       ...
       // if(!(isSelectedkCentral|isSelectedkSemiCentral|isSelectedPeripheral)){cout<<"Event Rejected"<<endl; return;} //
       // if(!(isSelectedkCentral|isSelectedkSemiCentral|isSelectedMBall)){cout<<"Event Rejected"<<endl; return;} //
    }
