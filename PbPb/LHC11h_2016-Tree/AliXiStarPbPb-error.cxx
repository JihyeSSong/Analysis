...
void AliXiStarPbPb::XiStarInit()
{
 ...
 //inpPb   fMultBins = 11;// This must also be set in AliXiStarPbPb.h
  ...
  //  fMultBins = 4;// for semi - central collisions
   ...
   fMultLimits[0]=0, fMultLimits[1]=200, fMultLimits[2]=600, fMultLimits[3]=1100, fMultLimits[4]=2500,fMultLimits[5]=5000, fMultLimits[6]=6000, fMultLimits[7]=10000, fMultLimits[8]=14000, fMultLimits[9]=17000, fMultLimits[10]=20000; //For MB
 ...
 */
    ...
    TH1F *fMultDist5 = new TH1F("fMultDist5","Multiplicity Distribution of mytrack",kNbinsM*10,-.5,kNbinsM*100-.5);
    fMultDist5->GetXaxis()->SetTitle("Multiplicity");
    fOutputList->Add(fMultDist5);
    
    
    TH2F *fMultDistVsCentrality = new TH2F("fMultDistVsCentrality","fMultDistVsCentrality",100,0,100,kNbinsM*10,-.5,kNbinsM*100-.5);
    fOutputList->Add(fMultDistVsCentrality);
    
    
    
    TH1F *fMultDist6 = new TH1F("fMultDist6","Multiplicity Distribution",kNbinsM*10,-.5,kNbinsM*100-.5);
...
//   fEventCounter++;
   ...
   // lCentrality =  fCentrality->GetCentralityPercentile(fCentralityEstimator.Data());
    ...
    Bool_t isSelectedAll =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() & (AliVEvent::kMB|AliVEvent::kCentral|AliVEvent::kSemiCentral));
    if(isSelectedAll) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(5);
    ...
    if(!fMCcase){
        if(!isSelectedAll) {cout<<"Event Rejected"<<endl; return;}
    }
    
    

    ((TH1F*)fOutputList->FindObject("hCentralitySelected"))->Fill(centralityV0M);
    ((TH1F*)fOutputList->FindObject("hCentralityNoFlatSelected"))->Fill(centralityV0MnoFlat);
 ...
 /* TPC OFF */           if(nsigpi>nSigTPCPID) continue; // last update // 20140715 // TPC
    ...
    if(myTracks >= 1) {
        ...
        ((TH1F*)fOutputList->FindObject("fMultDistVsCentrality"))->Fill(centralityV0M,myTracks);
