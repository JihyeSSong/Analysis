AliAnalysisGrid* CreateAlienHandler(bool MCcase)
{
 ...
 //   plugin->SetAliROOTVersion("vAN-20141030");
    ...
    if(!MCcase) plugin->SetGridWorkingDir("11h_2016Feb10-SemiCent-set6");
  //  if(!MCcase) plugin->SetGridWorkingDir("11h_2015July12-SemiCent-set1");
    ...
    plugin->SetSplitMaxInputFileNumber(20); //50 // 2015Feb
