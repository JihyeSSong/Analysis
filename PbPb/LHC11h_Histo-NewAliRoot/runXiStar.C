void runXiStar(int Nevents=10, bool batchmode=kFALSE, bool MCcase=kFALSE, bool AODcase=kFALSE, const char* collectionfile="collection.xml", const char* outfilename="MyOutput.root") {
    ...
    gSystem->AddIncludePath( "-IALICE_PHYSICS/include" );
    ...
    //myTask->SelectCollisionCandidates(AliVEvent::kMB |AliVEvent::kCentral|AliVEvent::kSemiCentral);
    
    
    
    //myTask->UseESDTriggerMask(AliVEvent::kMB |AliVEvent::kCentral|AliVEvent::kSemiCentral);
