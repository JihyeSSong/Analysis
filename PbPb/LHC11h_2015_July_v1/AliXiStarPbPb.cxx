 ...
 */
    ...
    TH1F *hCentralitySelected010 = new TH1F("hCentralitySelected010","Centrality : after MB event selection",100,0,100);
    hCentralitySelected010->GetXaxis()->SetTitle("Centrality");
    fOutputList->Add(hCentralitySelected010);
   ...
   // fOutputList->Add(fPhiPtDist);
    ...
    for(Int_t cv=0; cv<kNCutVariations; cv++){
        ...
        if(cv==0){
            ...
            *nameXi += cv;
            *nameXibar += cv;
            CutVar[cv].fXi = new TH3F(nameXi->Data(),"Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
            fOutputList->Add(CutVar[cv].fXi);
            CutVar[cv].fXibar = new TH3F(nameXibar->Data(),"Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
            ...
            *nameMCrecXi += cv;
            *nameMCrecXibar += cv;
            CutVar[cv].fMCrecXi = new TH3F(nameMCrecXi->Data(),"Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
           CutVar[cv].fMCrecXibar = new TH3F(nameMCrecXibar->Data(),"Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
        ...
        *nameXiPlusPiMinusbkg += cv;
        CutVar[cv].fXiMinusPiPlus  = new TH3F(nameXiMinusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiMinusPiMinus = new TH3F(nameXiMinusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiPlusPiPlus   = new TH3F(nameXiPlusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiPlusPiMinus  = new TH3F(nameXiPlusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiMinusPiPlusbkg  = new TH3F(nameXiMinusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiMinusPiMinusbkg = new TH3F(nameXiMinusPiMinusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiPlusPiPlusbkg   = new TH3F(nameXiPlusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        CutVar[cv].fXiPlusPiMinusbkg  = new TH3F(nameXiPlusPiMinusbkg->Data(),"Invariant Mass Distribution", 100,0,10,10,0, 20, 200,1.4,1.6);
        ...
        *nameMCrecXiPlusPiMinus += cv;
        CutVar[cv].fMCrecXiMinusPiPlus  = new TH3F(nameMCrecXiMinusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
        CutVar[cv].fMCrecXiPlusPiMinus  = new TH3F(nameMCrecXiPlusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
    ...
    TH3F *fMCinputTotalXiStar1 = new TH3F("fMCinputTotalXiStar1","Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar1 = new TH3F("fMCinputTotalXiStarbar1","Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar1);
    fOutputList->Add(fMCinputTotalXiStarbar1);
    
    TH3F *fMCinputTotalXi1 = new TH3F("fMCinputTotalXi1","Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar1 = new TH3F("fMCinputTotalXibar1","Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
    fOutputList->Add(fMCinputTotalXi1);
    fOutputList->Add(fMCinputTotalXibar1);
    
    //
    
    TH3F *fMCinputTotalXiStar3 = new TH3F("fMCinputTotalXiStar3","Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar3 = new TH3F("fMCinputTotalXiStarbar3","Invariant Mass Distribution", 100,0,10, 10,0,20, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar3);
    fOutputList->Add(fMCinputTotalXiStarbar3);
    
    TH3F *fMCinputTotalXi3 = new TH3F("fMCinputTotalXi3","Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar3 = new TH3F("fMCinputTotalXibar3","Invariant Mass Distribution", 100,0,10, 10,0, 20, 200,1.2,1.4);
...
void AliXiStarPbPb::Exec(Option_t *)
{
  ...
  //  fMCcase = kTRUE;
   ...
   // lCentrality =  fCentrality->GetCentralityPercentile(fCentralityEstimator.Data());
    ...
    if(centralityV0MnoFlat<10.0)((TH1F*)fOutputList->FindObject("hCentralityNoFlatSelected"))->Fill(centralityV0MnoFlat);
    
    if(centralityV0M>10.0)return;

    ((TH1F*)fOutputList->FindObject("hCentralitySelected010"))->Fill(centralityV0M);
       ...
       fEventNumber =
        ...
        if(fMCcase){
            ...
            for (Int_t it = 0; it < mcstack->GetNprimary(); it++) {
                ...
                if(MCxiStarY<-0.8 ||MCxiStarY>0.8) continue; // here selection of rapidity for PbPb analysis
 ...
 /* TPC OFF */           if(nsigpi>nSigTPCPID) continue; // last update // 20140715 // TPC
    ...
    if(fMCcase){// get Input MC information for ESD case
        ...
        for (Int_t it = 0; it < mcstack->GetNprimary(); it++) {
            ...
            if(mcInputTrackXiStar->Y()<-0.8 ||mcInputTrackXiStar->Y()>0.8) continue; // here selection of rapidity for PbPb analysis
       ...
       // if(StandardXi)((TH1F*)fOutputList->FindObject("fCutEvents"))->Fill(12,1);
        ...
        for(Int_t EN=0; EN<fEventsToMix+1; EN++){// Event buffer loop
            ...
            for(Int_t l=0; l<(fEvt+EN)->fNTracks; l++){// Present(EN=0) and Past(EN from 1 to fEventsToMix) event track loop
                ...
                if(xiStarY<-0.8 ||xiStarY>0.8) continue; // here selection of rapidity for PbPb analysis
...
Double_t AliXiStarPbPb::ApplyCentFlatPbPb2011(){
    ...
    if (fMCcase){
        N2 = 1.00219e+05; //N2 is the reference
