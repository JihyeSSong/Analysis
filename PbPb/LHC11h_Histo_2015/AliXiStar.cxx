...
*/
    ...
    for(Int_t i=0; i<fESD->GetNumberOfCascades(); i++){
      ...
      //PIDOFF  if(Xinsigpr<-3.||Xinsigpr>3.) continue; // PID for proton
      //PIDOFF  if(Xinsigpi1<-3.||Xinsigpi1>3.) continue; // PID for 1st pion
      //PIDOFF  if(Xinsigpi2<-3.||Xinsigpi2>3.) continue; // PID for 2nd pion
