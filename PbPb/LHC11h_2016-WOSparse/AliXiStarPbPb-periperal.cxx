...
#include "AliVEventHandler.h" //march26
...
void AliXiStarPbPb::Exec(Option_t *)
{
  ...
  //  fMCcase = kTRUE;
    ...
    Bool_t isSelected5090 = kFALSE;
    if(centralityV0M>50. && centralityV0M<90.){
        isSelected5090 =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() && AliVEvent::kMB);
        if(isSelected5090) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(4);
    }
    ...
    Bool_t isSelectedPeripheral = !isSelectedkSemiCentral && isSelected5090;
    if(isSelectedPeripheral) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(5);

    
    Bool_t isSelected =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() && AliVEvent::kMB);
    if(isSelected) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(8);
    
    if(isSelectedkCentral|isSelectedkSemiCentral|isSelectedMB)((TH1F*)fOutputList->FindObject("hCentralitySelected050"))->Fill(centralityV0M);
    ...
    if(!fMCcase){
      ...
      //  if(!isSelectedkALL) {cout<<"Event Rejected"<<endl; return;}
        if(!(isSelectedkCentral|isSelectedkSemiCentral|isSelectedPeripheral)){cout<<"Event Rejected"<<endl; return;} //step 1
     //   if(!isSelectedMB) {cout<<"Event Rejected"<<endl; return;} //step 2
