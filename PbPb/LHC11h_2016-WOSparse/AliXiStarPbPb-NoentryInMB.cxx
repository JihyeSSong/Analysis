...
fMultLimits[0]=0, fMultLimits[1]=50, fMultLimits[2]=100, fMultLimits[3]=200, fMultLimits[4]=400,fMultLimits[5]=800, fMultLimits[6]=1400, fMultLimits[7]=2000, fMultLimits[8]=3000, fMultLimits[9]=4000, fMultLimits[10]=8000; //For MB
...
void AliXiStarPbPb::Exec(Option_t *)
{
  ...
  //  fMCcase = kTRUE;
    ...
    Float_t  centralityV0MnoFlat = -100.0;
    Float_t centralityV0M = -100.0;
