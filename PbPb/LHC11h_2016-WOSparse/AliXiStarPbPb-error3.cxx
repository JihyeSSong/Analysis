 ...
 */
   ...
   // fOutputList->Add(fPhiPtDist);
    ...
    TH1F *hXiInvMass = new TH1F("hXiInvMass","Xi invariant mass distribution : cent 0 - 10",100,1.2,1.4);
    fOutputList->Add(hXiInvMass);
    
    TH1F *hQAXiInvMass = new TH1F("hQAXiInvMass","Xi invariant mass distribution after mass window selection : cent 0 - 10",100,1.2,1.4);
    fOutputList->Add(hQAXiInvMass);
    
   
    
    
    TH2F *TPCPID = new TH2F("TPCPID","PID via TPC",100,0,20,100,0,200);
    fOutputList->Add(TPCPID);
    TH2F *hTPCPIDpi = new TH2F("hTPCPIDpi","PID pion",100,0,20,100,0,200);
    fOutputList->Add(hTPCPIDpi);
    TH2F *hTPCPIDk = new TH2F("hTPCPIDk","PID kaon",100,0,20,100,0,200);
    fOutputList->Add(hTPCPIDk);
    TH2F *hTPCPIDp = new TH2F("hTPCPIDp","PID proton",100,0,20,100,0,200);
    fOutputList->Add(hTPCPIDp);
    
    
    
    
    TH2F *hdEdxProton = new TH2F("hdEdxProton","Xi PID p",100,0,20,100,0,200);
    fOutputList->Add(hdEdxProton);
    TH2F *hdEdxPion1 = new TH2F("hdEdxPion1","Xi PID pi",100,0,20,100,0,200);
    fOutputList->Add(hdEdxPion1);
    TH2F *hdEdxPion2 = new TH2F("hdEdxPion2","Xi PID pi_b",100,0,20,100,0,200);
    fOutputList->Add(hdEdxPion2);
    
    TH2F *hdEdxProtonAfter = new TH2F("hdEdxProtonAfter","Xi PID p",100,0,20,100,0,200);
    fOutputList->Add(hdEdxProtonAfter);
    TH2F *hdEdxPion1After = new TH2F("hdEdxPion1After","Xi PID pi",100,0,20,100,0,200);
    fOutputList->Add(hdEdxPion1After);
    TH2F *hdEdxPion2After = new TH2F("hdEdxPion2After","Xi PID pi_b",100,0,20,100,0,200);
    fOutputList->Add(hdEdxPion2After);
    
    
    
    
    TH2F *hNSig3rdPion = new TH2F("hNSig3rdPion","nSigma 3rd pion",100,0,20,100,-5,5);
    fOutputList->Add(hNSig3rdPion);
    TH2F *hQANSig3rdPion = new TH2F("hQANSig3rdPion","nSigma 3rd pion : QA",100,0,20,100,-5,5);
    ...
    for(Int_t cv=0; cv<kNCutVariations; cv++){
        ...
        *nameXiPlusPiMinusbkg += cv;
        CutVar[cv].fXiMinusPiPlus  = new TH3F(nameXiMinusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiMinusPiMinus = new TH3F(nameXiMinusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiPlusPiPlus   = new TH3F(nameXiPlusPiPlus->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiPlusPiMinus  = new TH3F(nameXiPlusPiMinus->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiMinusPiPlusbkg  = new TH3F(nameXiMinusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiMinusPiMinusbkg = new TH3F(nameXiMinusPiMinusbkg->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiPlusPiPlusbkg   = new TH3F(nameXiPlusPiPlusbkg->Data(),"Invariant Mass Distribution", 100,0,10,100,0,100, 300,1.4,2.0);
        CutVar[cv].fXiPlusPiMinusbkg  = new TH3F(nameXiPlusPiMinusbkg->Data(),"Invariant Mass Distribution",100,0,10,100,0,100, 300,1.4,2.0);
