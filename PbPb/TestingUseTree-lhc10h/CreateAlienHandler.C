AliAnalysisGrid* CreateAlienHandler(bool MCcase)
{
   ...
   // TString *Production=new TString("11h");
    ...
    if(!MCcase) plugin->SetGridWorkingDir("10h_GoodRuns_Dec16");
...
Int_t AddGoodRuns(AliAnalysisAlien* plugin,TString lhcPeriod,bool MCcase=kFALSE) {
    ...
    Int_t nruns=0,ngoodruns=0;
     ...
     nruns=30; //93
         Int_t runlist[30]={
             139510, 139507, 139505, 139503, 139465, 139438, 139437, 139360, 139329, 139328, 139314, 139310, 139309, 139173, 139107, 139105, 139038, 139037, 139036, 139029, 139028, 138872, 138871, 138870, 138837, 138732, 138730, 138666, 138662, 138653};
         
         /* 138652, 138638, 138624, 138621, 138583, 138582, 138579, 138578, 138534, 138469, 138442, 138439, 138438, 138396, 138364, 138275, 138225, 138201, 138197, 138192,
         138190, 137848, 137844, 137752, 137751, 137724, 137722, 137718, 137704, 137693};,
             ...
             137432, 137431, 137430, 137366, 137243, 137236, 137235, 137232, 137231, 137230,
             137162, 137161, 137135};
           */  
