...
void AliXiStarPbPb::XiStarInit()
{
 ...
 //inpPb   fMultBins = 11;// This must also be set in AliXiStarPbPb.h
  ...
  //  fMultBins = 4;// for semi - central collisions
    ...
    fMultLimits[0]=0, fMultLimits[1]=9000, fMultLimits[2]=20000; // for central collisions
...
void AliXiStarPbPb::UserCreateOutputObjects()
{
    ...
    TH1F *fMultDist5 = new TH1F("fMultDist5","Multiplicity Distribution of Xitrack",kNbinsM,-.5,kNbinsM*100-.5);
