...
/*
    ...
    */
    ...
    TH1F *hCentralitykMB = new TH1F("hCentralitykMB","Centrality : after MB event selection",100,0,100);
    hCentralitykMB->GetXaxis()->SetTitle("hCentralitykMB");
    fOutputList->Add(hCentralitykMB);
  ...
  //  if (!isSelected) {cout<<"No event selected"<<endl; return;}
    ...
    if(!fAODcase){
        ...
        Bool_t isSelected =(((AliInputEventHandler*)(AliAnalysisManager::GetAnalysisManager()->GetInputEventHandler()))->IsEventSelected() && AliVEvent::kMB);
            if(isSelected) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(6);
    ...
    ((TH1F*)fOutputList->FindObject("hCentralitykMB"))->Fill(centralityV0M);
