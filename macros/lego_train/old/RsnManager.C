...
//   usePhysSel              = AliVEvent::kMB;
   ...
   TString alirootver = "v5-04-61-AN"; //jisong
//      alirootver = "v5-03-07-AN";

//   TString legoTrainPath = "$ALICE_ROOT/PWGLF/RESONANCES/macros/lego_train";
    TString legoTrainPath= "/Users/songjihye/alice/AliRsn/PWGLF/RESONANCES/macros/lego_train/old";
    
//    legoTrainPath = "/Users/songjihye/alice/AliRsn/PWGLF/RESONANCES/macros/lego_train";
...
//    AddResonanceToRsnManager(listRsn,"AddRsnToManagerRho.C",legoTrainPath.Data());
   ...
   //============= ONLY for GRID ====================
// jisong   TString dsConfig = "datasets-grid/AOD/LHC10h_p2_AOD049.txt";
    TString dsConfig = "datasets-grid/LHC10h_p2_AOD049.txt";
...
Bool_t AddResonanceToRsnManager(TList *listRsn,TString rsnAddMacro="AddRsnToManagerLambda.C",TString path="") {
