...
void AliXiStar::Exec(Option_t *)
{
  ...
  //  cout<<"wrong here before?"<<endl;
    
    
    TClonesArray *mcArray       = 0x0;
    
  //  cout<<"wrong here after?"<<endl;
 ...
 //        ((ULong64_t)fESD->GetBunchCrossNumber() )  );
       ...
       // fEventNumberMC = GetMCEventNumber();
       // fEventNumber = fEventNumberMC;
   ...
   //     if(fMCcase){
   //         fTreeVariableEventNumber1 = fEventNumberMC;
   //     }
   //     else
        // 17Sep fTreeVariableEventNumber1 = fEventNumber;
      ...
      //      if(fMCcase){
      //          fTreeVariableEventNumber3 =  fEventNumberMC;
      //      }
      //      else
    ...
    //    if(fMCcase){
    //        fTreeVariableEventNumber2 = fEventNumberMC;
    //    }
    //    else
