...
fTreeVariableTPCPIDp(0),
fTreeVariableTPCPIDpi1(0),
fTreeVariableTPCPIDpi2(0),
fTreeVariableTPCPIDpi3(0),
...
fTreeVariableTPCPIDp(obj.fTreeVariableTPCPIDp),
fTreeVariableTPCPIDpi1(obj.fTreeVariableTPCPIDpi1),
fTreeVariableTPCPIDpi2(obj.fTreeVariableTPCPIDpi2),
fTreeVariableTPCPIDpi3(obj.fTreeVariableTPCPIDpi3),
...
void AliXiStar::XiStarInit()
{
    ...
    fCutValues[0][4] = 0.03; fCutValues[0][5] = 0.03; fCutValues[0][6] = 0.01; fCutValues[0][7] = 0.01; fCutValues[0][8] = 2.0;
    fCutValues[0][9] = 1.5;
    fCutValues[0][10] = 2.0;
    fCutValues[0][11] = 1.4;
    fCutValues[0][12] = 0.8;
    ...
    fCutValues[1][0] = 70; fCutValues[1][1] = 80; fCutValues[1][2] = 80; fCutValues[1][3] = 80;// 80
...
void AliXiStar::UserCreateOutputObjects()
{
    ...
    fTreeXi->Branch("fTreeVariableTPCPIDp",&fTreeVariableTPCPIDp,"fTreeVariableTPCPIDp/F");
    fTreeXi->Branch("fTreeVariableTPCPIDpi1",&fTreeVariableTPCPIDpi1,"fTreeVariableTPCPIDpi1/F");
    fTreeXi->Branch("fTreeVariableTPCPIDpi2",&fTreeVariableTPCPIDpi2,"fTreeVariableTPCPIDpi2/F");
    ...
    fTreePi->Branch("fTreeVariableTPCPIDpi3",&fTreeVariableTPCPIDpi3,"fTreeVariableTPCPIDpi3/F");
 ...
 */
    ...
    TH2F *hNsigPi3 = new TH2F("hNsigPi3","nsigpion",1000,0,20,1000,-5,5);
    fOutputList->Add(hNsigPi3);
...
void AliXiStar::Exec(Option_t *)
{
    ...
    if(isSelectedkINT7) ((TH1F*)fOutputList->FindObject("hEventSelecInfo"))->Fill(7);
   ...
   // TClonesArray *mcArray       = 0x0;
    ...
    /////////////////////////////////////////////////
        ...
        if(fabs(primaryVtx[2]) > 15.) return; // Z-Vertex Cut
       ...
       if(PrimaryVertexESD->GetNContributors() < 1) return; // Enrico cut
        ...
        for (Int_t i = 0; i < fESD->GetNumberOfTracks(); i++) {
            ...
            ((TH2F*)fOutputList->FindObject("hNsigPi3"))->Fill(pidmom,fPIDResponse->NumberOfSigmasTPC(esdtrack,AliPID::kPion));
            
            //=========selecting 3rd pionusing PID=========//
            if(nsigpi>3.5) continue; // last update // 20140715
    ...
    for(Int_t i=0; i<fESD->GetNumberOfCascades(); i++){
        ...
        if(Xinsigpr<-3.5||Xinsigpr>3.5) continue; // PID for proton
        if(Xinsigpi1<-3.5||Xinsigpi1>3.5) continue; // PID for 1st pion
        if(Xinsigpi2<-3.5||Xinsigpi2>3.5) continue; // PID for 2nd pion
        
        // myxiTracks++; //current // wrong
    ...
    //    if(fDecayParameters[14] < 0.96) continue;// Cos PA Xi : 0.97
        ...
        fTreeVariableTPCPIDp = Xinsigpr;
        fTreeVariableTPCPIDpi1 = Xinsigpi1;
        fTreeVariableTPCPIDpi2 = Xinsigpi2;
