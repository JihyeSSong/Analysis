void runXiStar(int Nevents=10, bool batchmode=kFALSE, bool MCcase=kTRUE, bool AODcase=kFALSE, bool fUseTree = kFALSE, const char* collectionfile="collection.xml", const char* outfilename="MyOutput.root") {
    ...
    //   gROOT->LoadMacro("$ALICE_ROOT/PWGLF/FORWARD/analysis2/scripts/AliESDCentrality.C");
