...
//fTreeVariableMCrecXiPlusPiMinusPt(0),
//fTreeVariableMCrecXiPlusPiMinusY(0),
//fTreeVariableMCrecXiPlusPiMinusMass(0),
...
//fTreeVariableMCrecXiPlusPiMinusPt(obj.fTreeVariableMCrecXiPlusPiMinusPt),
//fTreeVariableMCrecXiPlusPiMinusY(obj.fTreeVariableMCrecXiPlusPiMinusY),
//fTreeVariableMCrecXiPlusPiMinusMass(obj.fTreeVariableMCrecXiPlusPiMinusMass),
...
void AliXiStar::UserCreateOutputObjects()
{
    ...
    fTreeXi->Branch("fTreeVariableMCrecXiSongPID",&fTreeVariableMCrecXiSongPID,"fTreeVariableMCrecXiSongPID/F");
    ...
    fTreeMC->Branch("fTreeVariableMCinputTotalSongPID",&fTreeVariableMCinputTotalSongPID,"fTreeVariableMCinputTotalSongPID/F");
    ...
    for(Int_t i=0; i<fESD->GetNumberOfCascades(); i++){
        ...
        for(Int_t EN=0; EN<fEventsToMix+1; EN++){// Event buffer loop
            ...
            for(Int_t l=0; l<(fEvt+EN)->fNTracks; l++){// Present(EN=0) and Past(EN from 1 to fEventsToMix) event track loop
                ...
                if(fMCcase && EN==0 && !fAODcase){// ESD MC's
                   ...
                   // fTreeVariableMCrecXiStarSongPID = -1;
                    ...
                    fTreeVariableMCXiStarD2esd = abs(MCXiStarD2esd->GetPdgCode());
                    fTreeVariableMCXiMom = MCXiesd->GetMother(0);
                    fTreeVariableMCXiStarD2Mom = MCXiStarD2esd->GetMother(0);
                    fTreeVariableMCXiStaresd = abs(MCXiStaresd->GetPdgCode());
                        ...
                        if(abs(MCXiStarD2esd->GetPdgCode())==kPionCode){
                            if(MCXiesd->GetMother(0) == MCXiStarD2esd->GetMother(0)){
                                ...
                                if(abs(MCXiStaresd->GetPdgCode())==kXiStarCode) {
                                    ...
                                    // fTreeMC1->Fill(); current version 3/May
                                }
