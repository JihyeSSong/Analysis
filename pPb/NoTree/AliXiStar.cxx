...
void AliXiStar::XiStarInit()
{
   ...
   // loose cut
    fCutValues[0][0] = 60; fCutValues[0][1] = 60; fCutValues[0][2] = 60; fCutValues[0][3] = 60;
    fCutValues[0][4] = 0.02; fCutValues[0][5] = 0.02; fCutValues[0][6] = 0.02; fCutValues[0][7] = 0.05; fCutValues[0][8] = 2.0;
    fCutValues[0][9] = 1.8;
    fCutValues[0][10] = 1.8;
    fCutValues[0][11] = 1.2;
    fCutValues[0][12] = 0.6;
    fCutValues[0][13] = 0.96;
    fCutValues[0][14] = 0.96;
...
/*
  ...
  */
    ...
    TH3F *fMCinputTotalXi020 = new TH3F("fMCinputTotalXi020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar020 = new TH3F("fMCinputTotalXibar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCinputTotalXi020);
    fOutputList->Add(fMCinputTotalXibar020);
    
    TH3F *fMCinputTotalXi2040 = new TH3F("fMCinputTotalXi2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar2040 = new TH3F("fMCinputTotalXibar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCinputTotalXi2040);
    fOutputList->Add(fMCinputTotalXibar2040);
    
    TH3F *fMCinputTotalXi4060 = new TH3F("fMCinputTotalXi4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar4060 = new TH3F("fMCinputTotalXibar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCinputTotalXi4060);
    fOutputList->Add(fMCinputTotalXibar4060);
    
    TH3F *fMCinputTotalXi60100 = new TH3F("fMCinputTotalXi60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCinputTotalXibar60100 = new TH3F("fMCinputTotalXibar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCinputTotalXi60100);
    fOutputList->Add(fMCinputTotalXibar60100);
    ...
    TH3F *fMCinputTotalXiStar020 = new TH3F("fMCinputTotalXiStar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar020 = new TH3F("fMCinputTotalXiStarbar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar020);
    fOutputList->Add(fMCinputTotalXiStarbar020);

    TH3F *fMCinputTotalXiStar2040 = new TH3F("fMCinputTotalXiStar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar2040 = new TH3F("fMCinputTotalXiStarbar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar2040);
    fOutputList->Add(fMCinputTotalXiStarbar2040);

    TH3F *fMCinputTotalXiStar4060 = new TH3F("fMCinputTotalXiStar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar4060 = new TH3F("fMCinputTotalXiStarbar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar4060);
    fOutputList->Add(fMCinputTotalXiStarbar4060);

    TH3F *fMCinputTotalXiStar60100 = new TH3F("fMCinputTotalXiStar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCinputTotalXiStarbar60100 = new TH3F("fMCinputTotalXiStarbar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCinputTotalXiStar60100);
    fOutputList->Add(fMCinputTotalXiStarbar60100);

    // MC output
    TH3F *fMCoutputTotalXi0100 = new TH3F("fMCoutputTotalXi0100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCoutputTotalXibar0100 = new TH3F("fMCoutputTotalXibar0100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCoutputTotalXi0100);
    fOutputList->Add(fMCoutputTotalXibar0100);
    
    
    TH3F *fMCoutputTotalXi020 = new TH3F("fMCoutputTotalXi020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCoutputTotalXibar020 = new TH3F("fMCoutputTotalXibar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCoutputTotalXi020);
    fOutputList->Add(fMCoutputTotalXibar020);
    
    TH3F *fMCoutputTotalXi2040 = new TH3F("fMCoutputTotalXi2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCoutputTotalXibar2040 = new TH3F("fMCoutputTotalXibar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCoutputTotalXi2040);
    fOutputList->Add(fMCoutputTotalXibar2040);
    
    TH3F *fMCoutputTotalXi4060 = new TH3F("fMCoutputTotalXi4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCoutputTotalXibar4060 = new TH3F("fMCoutputTotalXibar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCoutputTotalXi4060);
    fOutputList->Add(fMCoutputTotalXibar4060);
    
    TH3F *fMCoutputTotalXi60100 = new TH3F("fMCoutputTotalXi60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    TH3F *fMCoutputTotalXibar60100 = new TH3F("fMCoutputTotalXibar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.2,1.4);
    fOutputList->Add(fMCoutputTotalXi60100);
    fOutputList->Add(fMCoutputTotalXibar60100);

    
    TH3F *fMCoutputTotalXiStar0100 = new TH3F("fMCoutputTotalXiStar0100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCoutputTotalXiStarbar0100 = new TH3F("fMCoutputTotalXiStarbar0100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCoutputTotalXiStar0100);
    fOutputList->Add(fMCoutputTotalXiStarbar0100);
    
    
    TH3F *fMCoutputTotalXiStar020 = new TH3F("fMCoutputTotalXiStar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCoutputTotalXiStarbar020 = new TH3F("fMCoutputTotalXiStarbar020","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCoutputTotalXiStar020);
    fOutputList->Add(fMCoutputTotalXiStarbar020);
    
    TH3F *fMCoutputTotalXiStar2040 = new TH3F("fMCoutputTotalXiStar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCoutputTotalXiStarbar2040 = new TH3F("fMCoutputTotalXiStarbar2040","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCoutputTotalXiStar2040);
    fOutputList->Add(fMCoutputTotalXiStarbar2040);
    
    TH3F *fMCoutputTotalXiStar4060 = new TH3F("fMCoutputTotalXiStar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCoutputTotalXiStarbar4060 = new TH3F("fMCoutputTotalXiStarbar4060","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCoutputTotalXiStar4060);
    fOutputList->Add(fMCoutputTotalXiStarbar4060);
    
    TH3F *fMCoutputTotalXiStar60100 = new TH3F("fMCoutputTotalXiStar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    TH3F *fMCoutputTotalXiStarbar60100 = new TH3F("fMCoutputTotalXiStarbar60100","Invariant Mass Distribution", 100,0,10, 40,-2,2, 200,1.4,1.6);
    fOutputList->Add(fMCoutputTotalXiStar60100);
    fOutputList->Add(fMCoutputTotalXiStarbar60100);
    ...
    TH1F *fMCinputXiStarY = new TH1F("fMCinputXiStarY","fMCinputXiStarY",400,-2,2);
    fOutputList->Add(fMCinputXiStarY);

    TH1F *fMCrecXiStartest = new TH1F("fMCrecXiStartest","fMCrecXiStartest",1000,0,110);
    fOutputList->Add(fMCrecXiStartest);
    ...
    if(fMCcase && !fAODcase){// get Input MC information for ESD case
        ...
        for (Int_t it = 0; it < mcstack->GetNprimary(); it++) {
            ...
            if(mcInputTrackXi->GetPdgCode() == +kXiCode) {
                ...
                if(lCentrality>0.0 && lCentrality<=20.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXi020"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>20.0 && lCentrality<=40.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXi2040"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>40.0 && lCentrality<=60.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXi4060"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>60.0 && lCentrality<=100.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXi60100"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                ...
                if(lCentrality>0.0 &&lCentrality<20.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXibar020"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>20.0 &&lCentrality<=40.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXibar2040"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>40.0 &&lCentrality<=60.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXibar4060"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
                if(lCentrality>60.0 &&lCentrality<=100.0)((TH3F*)fOutputList->FindObject("fMCinputTotalXibar60100"))->Fill(mcInputTrackXi->Pt(), mcInputTrackXi->Y(), mcInputTrackXi->GetCalcMass());
        ...
        for (Int_t it = 0; it < mcstack->GetNprimary(); it++) {
            ...
            if(mcInputTrackXiStar->GetPdgCode() == +kXiStarCode) {
               ...
               ((TH1F*)fOutputList->FindObject("fMCinputXiStarY"))->Fill(mcInputTrackXiStar->Y());
                
                if(lCentrality>0 &&lCentrality<=20)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStar020"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>20 &&lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStar2040"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>40 &&lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStar4060"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>60 &&lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStar60100"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
            ...
            if(mcInputTrackXiStar->GetPdgCode() == -kXiStarCode){
                ...
                if(lCentrality>0 &&lCentrality<20)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStarbar020"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>20 &&lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStarbar2040"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>40 &&lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStarbar4060"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                if(lCentrality>60 &&lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCinputTotalXiStarbar60100"))->Fill(mcInputTrackXiStar->Pt(), mcInputTrackXiStar->Y(), mcInputTrackXiStar->GetCalcMass());
                                    ...
                                    if(abs(MCXiesd->GetPdgCode())==kXiCode) {
                                        ...
                                        if(StandardXi){
                                            if(Xicandidate->Charge() == -1){
                                                ...
                                                ((TH3F*)fOutputList->FindObject("fMCoutputTotalXi0100"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>0 && lCentrality<=20)((TH3F*)fOutputList->FindObject("fMCoutputTotalXi020"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>20 && lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCoutputTotalXi2040"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>40 && lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCoutputTotalXi4060"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>60 && lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCoutputTotalXi60100"))->Fill(xiPt, xiY, xiMass);
                                                

                                            }else{
                                                CutVar[0].fMCrecXibar->Fill(xiPt, xiY, xiMass);
                                                ((TH3F*)fOutputList->FindObject("fMCoutputTotalXibar0100"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>0 && lCentrality<20)((TH3F*)fOutputList->FindObject("fMCoutputTotalXibar020"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>20 && lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCoutputTotalXibar2040"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>40 && lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCoutputTotalXibar4060"))->Fill(xiPt, xiY, xiMass);
                                                if(lCentrality>60 && lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCoutputTotalXibar60100"))->Fill(xiPt, xiY, xiMass);
                        ...
                        if(MCXiesd->GetMother(0) == MCXiStarD2esd->GetMother(0)){
                            ...
                            if(abs(MCXiStaresd->GetPdgCode())==kXiStarCode) {
                                ...
                                if(fXiTrack->Charge() == -1 &&  fESDTrack4->Charge() == +1) {
                                    ((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStar0100"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    
                                    if(lCentrality>0 && lCentrality<=20)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStar020"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>20 && lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStar2040"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>40 && lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStar4060"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>60 && lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStar60100"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    
                                }
                                if(fXiTrack->Charge() == +1 &&  fESDTrack4->Charge() == -1){
                                    ((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStarbar0100"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>0 && lCentrality<20)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStarbar020"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>20 && lCentrality<=40)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStarbar2040"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>40 && lCentrality<=60)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStarbar4060"))->Fill(xiStarPt, xiStarY, xiStarMass);
                                    if(lCentrality>60 && lCentrality<=100)((TH3F*)fOutputList->FindObject("fMCoutputTotalXiStarbar60100"))->Fill(xiStarPt, xiStarY, xiStarMass);
                        ...
                        if(abs(MCXiStarD2esd->GetPdgCode())==kPionCode){
                            if(MCXiesd->GetMother(0) == MCXiStarD2esd->GetMother(0)){
                                ...
                                if(abs(MCXiStaresd->GetPdgCode())==kXiStarCode) {
                                    ...
                                    if(fXiTrack->Charge() == -1 &&  fESDTrack4->Charge() == +1) {
                                        CutVar[cv].fMCrecXiMinusPiPlus->Fill(xiStarPt, xiStarY, xiStarMass);
                                        ((TH1F*)fOutputList->FindObject("fMCrecXiStartest"))->Fill(lCentrality);
                                    }
                                    if(fXiTrack->Charge() == +1 &&  fESDTrack4->Charge() == -1){
                                        CutVar[cv].fMCrecXiPlusPiMinus->Fill(xiStarPt, xiStarY, xiStarMass);
                                        ((TH1F*)fOutputList->FindObject("fMCrecXiStartest"))->Fill(lCentrality);
                                    }
