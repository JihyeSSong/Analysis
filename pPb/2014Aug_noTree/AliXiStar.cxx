...
*/
    ...
    if(fAODcase){// AOD case
        ...
        centralityV0A = fCentrality->GetCentralityPercentile("V0A"); //T_R_K
    ...
    */
        ...
        for (Int_t i = 0; i < fESD->GetNumberOfTracks(); i++) {
            ...
            //=========selecting 3rd pionusing PID=========//
             if(nsigpi>3.) continue; // last update // 20140822
...
*/
        ...
        for(Int_t EN=0; EN<fEventsToMix+1; EN++){// Event buffer loop
            ...
            for(Int_t l=0; l<(fEvt+EN)->fNTracks; l++){// Present(EN=0) and Past(EN from 1 to fEventsToMix) event track loop
                ...
                if(fabs((fEvt+EN)->fTracks[l].fEta) > 0.8) continue; // original
                //if(fabs((fEvt+EN)->fTracks[l].fEta) > 0.8) continue; //Etachecking
