...
void AliXiStar::UserCreateOutputObjects()
{
    ...
    TH1F *hXi30_60 = new TH1F("hXi30_60","Xi invariant mass distribution : cent 30 - 60",200,1.2,1.4);
    fOutputList->Add(hXi30_60);
    
    
  //  TH1F *hXiStar30_60 = new TH1F("hXiStar30_60","Xi invariant mass distribution : cent 30 - 60",200,1.2,1.4);
  //  fOutputList->Add(hXiStar30_60);
    ...
    */
       ...
       // if(fESD->GetNumberOfTracks() > 200000 ) {cout<<"multiplicity is larger than 20000"<<endl; return;}
        ...
        for (Int_t i = 0; i < fESD->GetNumberOfTracks(); i++) {
           ...
           // ((TH2F*)fOutputList->FindObject("fDCADist"))->Fill(fESD->GetNumberOfTracks(), dca3d);
            ...
            // for third pion PID will be added here.
            // if(nxigp>3.) continue;
