...
private:
    ...
    TTree                  *fTreeXi, *fTreePi, *fTreeEvent, *fTreeMC, *fTreeMC1; //! Output Tree
 ...
 */
    Float_t fTreeVariableMCrecXiPt;
    Float_t fTreeVariableMCrecXiY;
    Float_t fTreeVariableMCrecXiMass;

    Float_t fTreeVariableMCrecXibarPt;
    Float_t fTreeVariableMCrecXibarY;
    Float_t fTreeVariableMCrecXibarMass;
    Int_t fTreeVariableMCrecXiSongPID;
    Float_t fTreeVariableMCrecXiCent;

  //  TParticle *fTreeVariableMCXiStarD2esd;
  //  TParticle *fTreeVariableMCXiesd;
  //  TParticle *fTreeVariableMCXiStaresd;

    
//    Int_t fTreeVariableMCXiStarD2esd;
//    Int_t fTreeVariableMCXiMom;
//    Int_t fTreeVariableMCXiStarD2Mom;
//    Int_t fTreeVariableMCXiStaresd;

    Float_t fTreeVariableMCrecXiStarPt;
    Float_t fTreeVariableMCrecXiStarY;
    Float_t fTreeVariableMCrecXiStarMass;
    
    Float_t fTreeVariableMCrecXiStarbarPt;
    Float_t fTreeVariableMCrecXiStarbarY;
    Float_t fTreeVariableMCrecXiStarbarMass;
    Int_t fTreeVariableMCrecXiStarSongPID;
    Float_t fTreeVariableMCrecXiStarCent;
    Float_t fTreeVariableMCXiFilled;
    Float_t fTreeVariableMCrecXiStarcv;
