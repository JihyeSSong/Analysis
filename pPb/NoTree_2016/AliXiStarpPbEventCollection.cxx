...
AliXiStarpPbTrackStruct::AliXiStarpPbTrackStruct():
  fStatus(0),
  fFilterMap(0),
  fID(0),
  fPhi(0),
...
AliXiStarpPbTrackStruct::AliXiStarpPbTrackStruct(const AliXiStarpPbTrackStruct &obj) 
  : fStatus(obj.fStatus),
...
//_____________________________________________________________________________
AliXiStarpPbTrackStruct &AliXiStarpPbTrackStruct::operator=(const AliXiStarpPbTrackStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliXiStarpPbEventStruct::AliXiStarpPbEventStruct():
  fNTracks(0),
  fTracks(0)
{
  //Default constructor
...
//_____________________________________________________________________________
AliXiStarpPbEventStruct::AliXiStarpPbEventStruct(const AliXiStarpPbEventStruct &obj) 
...
//_____________________________________________________________________________
AliXiStarpPbEventStruct &AliXiStarpPbEventStruct::operator=(const AliXiStarpPbEventStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliXiStarpPbEventCollection::AliXiStarpPbEventCollection():
  fFIFO(0),
  fEvtStr(0)
{
//Default constructor
...
//_____________________________________________________________________________
AliXiStarpPbEventCollection::AliXiStarpPbEventCollection(short a):
  fFIFO(0),
  fEvtStr(0x0)
{
  // main constructor
  ...
  fEvtStr = new AliXiStarpPbEventStruct[fFIFO];  //allocate pointer array
  for(Int_t ii = 0; ii < fFIFO; ii++){   //Initialize to NULL
    (fEvtStr + ii)->fTracks = NULL;
    (fEvtStr + ii)->fNTracks = 0;
     
    (fEvtStr + ii)->fTracks = new AliXiStarpPbTrackStruct[2000];
  }
  
}
//_____________________________________________________________________________
AliXiStarpPbEventCollection::AliXiStarpPbEventCollection(const AliXiStarpPbEventCollection &obj) 
  :  fFIFO(obj.fFIFO),
     fEvtStr(obj.fEvtStr)
{
  // copy constructor
...
//_____________________________________________________________________________
AliXiStarpPbEventCollection &AliXiStarpPbEventCollection::operator=(const AliXiStarpPbEventCollection &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
void AliXiStarpPbEventCollection::FIFOShift(){ //Shift elements in FIFO by one and clear last element in FIFO 
