...
void AliXiStar::UserCreateOutputObjects()
{
    ...
    TH1F *hXiCent0_30 = new TH1F("hXiCent0_30","Xi invariant mass distribution cent0_30",200,1.2,1.4);
    fOutputList->Add(hXiCent0_30);
    TH1F *hXiCent30_60 = new TH1F("hXiCent30_60","Xi invariant mass distribution cent30_60",200,1.2,1.4);
    fOutputList->Add(hXiCent30_60);
    TH1F *hXiCent60_90 = new TH1F("hXiCent60_90","Xi invariant mass distribution cent60_90",200,1.2,1.4);
    fOutputList->Add(hXiCent60_90);
    
    TH1F *hXiStarCent0_30 = new TH1F("hXiStarCent0_30","XiStar invariant mass distribution cent0_30",200,1.4,1.6);
    fOutputList->Add(hXiStarCent0_30);
    TH1F *hXiStarCent30_60 = new TH1F("hXiStarCent30_60","XiStar invariant mass distribution cent30_60",200,1.4,1.6);
    fOutputList->Add(hXiStarCent30_60);
    TH1F *hXiStarCent60_90 = new TH1F("hXiStarCent60_90","XiStar invariant mass distribution cent60_90",200,1.4,1.6);
    fOutputList->Add(hXiStarCent60_90);
...
/*
  ...
  */
    ...
    if(fAODcase){// AOD case
        ...
        // fTreeVariableEventCounter1 = fEventCounter;
        ...
        if(lCentrality<0.||lCentrality>30.) return; // current centrality checking by histo June 2
    ...
    for(Int_t i=0; i<fESD->GetNumberOfCascades(); i++){
        ...
        //   fTreeVariableEventCounter2 = fEventCounter;
        ...
        if(StandardXi){
            if(xiCharge == -1) {
                ...
                ((TH1F*)fOutputList->FindObject("hXiCent0_30"))->Fill(xiMass);
                //if(30.<lCentrality<60.)((TH1F*)fOutputList->FindObject("hXiCent30_60"))->Fill(xiMass);
                //if(60.<lCentrality<90.)((TH1F*)fOutputList->FindObject("hXiCent60_90"))->Fill(xiMass);
            }
            else{
                ...
                for(int cv=0; cv<kNCutVariations; cv++){
                    ...
                    if(EN==0){
                        if(fXiTrack->Charge() == -1 &&  fESDTrack4->Charge() == -1) CutVar[cv].fXiMinusPiMinus->Fill(xiStarPt, xiStarY, xiStarMass);
                            ...
                            ((TH1F*)fOutputList->FindObject("hXiStarCent0_30"))->Fill(xiStarMass);
                            // if(fCent ==2)((TH1F*)fOutputList->FindObject("hXiStarCent30_60"))->Fill(xiStarMass);
                            // if(fCent ==3)((TH1F*)fOutputList->FindObject("hXiStarCent60_90"))->Fill(xiStarMass);
