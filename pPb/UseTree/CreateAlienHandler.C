AliAnalysisGrid* CreateAlienHandler(bool MCcase)
{
    ...
    if(!MCcase) plugin->SetGridWorkingDir("lhc13c_woLooseCut10Sep");
...
Int_t AddGoodRuns(AliAnalysisAlien* plugin,TString lhcPeriod,bool MCcase=kFALSE) {
    ...
    if(lhcPeriod=="LHC13c") {
        nruns=26; // 150 runs
        Int_t runlist[26]={195344, 195346, 195351, 195389, 195390, 195391, 195478, 195479, 195480, 195481, 195482, 195483, 195529, 195531, 195566, 195567, 195568, 195592, 195593, 195596, 195633, 195635, 195644, 195673, 195675, 195677};
