...
AliSigmaPTrackStruct::AliSigmaPTrackStruct():
  fStatus(0),
  fFilterMap(0),
  fID(0),
  fPhi(0),
...
AliSigmaPTrackStruct::AliSigmaPTrackStruct(const AliSigmaPTrackStruct &obj) 
  : fStatus(obj.fStatus),
...
//_____________________________________________________________________________
AliSigmaPTrackStruct &AliSigmaPTrackStruct::operator=(const AliSigmaPTrackStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliSigmaPEventStruct::AliSigmaPEventStruct():
  fNTracks(0),
  fTracks(0)
{
  //Default constructor
...
//_____________________________________________________________________________
AliSigmaPEventStruct::AliSigmaPEventStruct(const AliSigmaPEventStruct &obj) 
...
//_____________________________________________________________________________
AliSigmaPEventStruct &AliSigmaPEventStruct::operator=(const AliSigmaPEventStruct &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
AliSigmaPEventCollection::AliSigmaPEventCollection():
  fFIFO(0),
  fEvtStr(0)
{
//Default constructor
...
//_____________________________________________________________________________
AliSigmaPEventCollection::AliSigmaPEventCollection(short a):
  fFIFO(0),
  fEvtStr(0x0)
{
  // main constructor
  ...
  fEvtStr = new AliSigmaPEventStruct[fFIFO];  //allocate pointer array
  for(Int_t ii = 0; ii < fFIFO; ii++){   //Initialize to NULL
    ...
    (fEvtStr + ii)->fTracks = new AliSigmaPTrackStruct[nStruct];
  }
  
}
//_____________________________________________________________________________
AliSigmaPEventCollection::AliSigmaPEventCollection(const AliSigmaPEventCollection &obj) 
  :  fFIFO(obj.fFIFO),
     fEvtStr(obj.fEvtStr)
{
  // copy constructor
...
//_____________________________________________________________________________
AliSigmaPEventCollection &AliSigmaPEventCollection::operator=(const AliSigmaPEventCollection &obj) 
{
  // Assignment operator  
  if (this == &obj)
    return *this;
...
//_____________________________________________________________________________
void AliSigmaPEventCollection::FIFOShift(){ //Shift elements in FIFO by one and clear last element in FIFO 
