void runXiStar(int Nevents=10, bool batchmode=kTRUE, bool MCcase=kFALSE, bool AODcase=kFALSE, bool fUseTree = kFALSE, const char* collectionfile="collection.xml", const char* outfilename="MyOutput.root") {
